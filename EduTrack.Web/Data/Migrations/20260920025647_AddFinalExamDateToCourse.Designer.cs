...
namespace EduTrack.Web.Data.Migrations
{
    ...
    [Migration("20260920025647_AddFinalExamDateToCourse")]
    partial class AddFinalExamDateToCourse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduTrack.Web.Models.ClassRoutine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SemesterLevel")
                        .IsRequired()
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("EduTrack.Web.Models.Course", b =>
                {
                    ...
                    b.Property<string>("FinalExamTime")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("EduTrack.Web.Models.Grade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduTrack.Web.Models.TeacherEvaluation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PeriodId", "EnrollmentId")
                        .IsUnique();

                    b.ToTable("TeacherEvaluations");
                });

            modelBuilder.Entity("EduTrack.Web.Models.TeacherEvaluationPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TeacherEvaluationPeriods");
                });
            ...
            modelBuilder.Entity("EduTrack.Web.Models.Grade", b =>
                {
                    b.HasOne("EduTrack.Web.Models.Enrollment", "Enrollment")
                        .WithOne("Grade")
                        .HasForeignKey("EduTrack.Web.Models.Grade", "EnrollmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EduTrack.Web.Models.Student", b =>
                {
                    b.HasOne("EduTrack.Web.Models.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("EduTrack.Web.Models.Student", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("EduTrack.Web.Models.Teacher", b =>
                {
                    b.HasOne("EduTrack.Web.Models.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("EduTrack.Web.Models.Teacher", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("EduTrack.Web.Models.TeacherEvaluation", b =>
                {
                    ...
                    b.HasOne("EduTrack.Web.Models.TeacherEvaluationPeriod", "Period")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EduTrack.Web.Models.ApplicationUser", null)
                        .WithMany()
